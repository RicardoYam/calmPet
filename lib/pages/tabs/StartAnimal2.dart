...
class StartAnimal2 extends StatefulWidget {
  const StartAnimal2({Key? key}) : super(key: key);

  @override
  State<StartAnimal2> createState() => _StartAnimalState();
}

class _StartAnimalState extends State<StartAnimal2> {
  double meanDb = 0;
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Image.asset(
                    checkNoise() ? "images/anini.png" : "images/animal2.png"),
              ),
            ],
          ),
        ),
